...
local config = {
    ...
    enterTiles = {
        from = Position(1065, 1030, 7),
        to   = Position(1068, 1030, 7)
    },
    ----------------------------------
    startPositions = {
        [1] = Position(1108, 1039, 7), -- top left     | 1 |   |   |   | 3 |
        [2] = Position(1122, 1049, 7), -- bottom right |   |   |   |   |   |
        [3] = Position(1122, 1039, 7), -- top right    |   |   |   |   |   |
        [4] = Position(1108, 1049, 7)  -- bottom left  | 4 |   |   |   | 2 |
    },
    ----------------------------------
    minPlayerLimit      = 1,
    maxPlayerLimit      = 4,
