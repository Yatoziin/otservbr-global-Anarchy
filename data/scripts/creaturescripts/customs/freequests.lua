...
[254] = {storageId = Storage.ThievesGuild.Mission08, storageValue = 3},
...
[318] = {storageId = Storage.ThreatenedDreams.TroubledMission01, storageValue = 17},
...
local upperLimit = 5 -- change upperLimit to a higher one after adding a new quest to questTable
